...
const marcaAudi = coches.filter((coche) => {
...
const marcaBMW = coches.filter((coche) => {
  return coche.marca === "BMW";
});

console.log(marcaBMW);

const colorBMW = marcaBMW.map((coche) => {
  return coche.color;
});

console.log(colorBMW);

//punto tres
const marcaFord = coches.filter((coche) => {
...
const transmisionManual = coches.filter((coche) => {
  return coche.transmision === "manual" && coche.color === "Negro";
});

console.log(transmisionManual);

// const transManualNegro = transmisionManual.filter((coche) => {
//   return coche.color === "Negro";
// });

// console.log(transManualNegro);

//punto 6

const sumaTotalPrecios = coches.reduce((previousValue, coche) => {
